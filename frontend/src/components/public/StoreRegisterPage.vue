<template>
    ...
    <div style="position:relative;margin-top:15vh;">
        <nut-form>
            ...
            <nut-space :gutter="10" style="position:absolute;left:5vw;margin-top:43vh;opacity: 70%;">
        ...
        <nut-cell style="position:absolute;margin-top:112vh;left:10%;width:305px;height:30px;opacity: 70%;">
